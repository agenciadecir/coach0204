  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      <div className="bg-gradient-to-r from-purple-900/50 via-slate-800 to-slate-800 rounded-2xl p-6 border border-purple-500/30">
        <h1 className="text-2xl sm:text-3xl font-bold text-white">Panel de Administrador</h1>
        <p className="text-slate-400 mt-1">Gestión de coaches y alumnos</p>
      </div>
          ...
          <Card className="bg-slate-800 border-slate-700">
            ...
            <CardContent className="space-y-3">
              {coaches.slice(0, 5).map((coach) => (
                <div key={coach.id} className="flex items-center justify-between p-3 bg-slate-700/50 rounded-lg">
                  <div className="flex items-center gap-3">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-slate-400 mt-1">{coach._count.students} alumnos</p>
                  </div>
                </div>
              ))}
            </CardContent>
        ...
        <div className="space-y-3">
          {filteredCoaches.length === 0 ? (
            ...
            filteredCoaches.map((coach) => (
              <Card key={coach.id} className="bg-slate-800 border-slate-700">
                <CardContent className="p-4">
